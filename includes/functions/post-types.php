 ...
 */
function THEME_DOMAIN_register_post_types()
{
    // $labels = array(
...
add_action( 'init', 'THEME_DOMAIN_register_post_types' );

/**
 * Remove default post type page
 */
function THEME_DOMAIN_remove_default_post_type()
{
    remove_menu_page( 'edit.php' );
}
// add_action( 'admin_menu', 'THEME_DOMAIN_remove_default_post_type' );

/**
 * Remove default post type link from admin sidebar
 */
function THEME_DOMAIN_remove_default_post_type_menu_bar( $wp_admin_bar )
{
    $wp_admin_bar->remove_node( 'new-post' );
}
// add_action( 'admin_bar_menu', 'THEME_DOMAIN_remove_default_post_type_menu_bar', 999 );
