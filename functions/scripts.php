...
{
    wp_enqueue_style( 'main-css', get_template_directory_uri(). '/build/css/app.css', array(), '1.0' );
    wp_enqueue_script( 'main-js', get_template_directory_uri(). '/build/js/app.js', array('jquery'), '1.0', true );
